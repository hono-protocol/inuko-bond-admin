...
import { Text, Flex, Box, ErrorIcon, Button } from "@bds-libs/uikit";
    ...
    >
      <Box ml="48px">
        <Text color="warning" bold>
          You must complete migration if you want to keep earning from any
          BecoSwap LP tokens and BecoSwap farms.
        </Text>
        <Text color="white" mb="16px">
          All LPs will be migrated to a new, upgraded contract, over several
