...
import { Heading, Box, PoolHouseIcon, Flex } from "@bds-libs/uikit";
...
const ProPools: React.FC<{ isPool?: boolean }> = ({ isPool = true }) => {
    ...
    <>
      <Hero>
        <>
          ...
          >
            <PoolHouseIcon mr="1rem" width="45px" color="rgb(164, 200, 186)" />
            {t("Pro Pools")}
          </Heading>
          <Box mt="25px" mb="0.25rem" textAlign="center">
            ...
            >
              {t(
                "Pools for tokens in Inuko token ecosystem to receive interesting APR."
              )}
            </Box>
          </Box>
          <Box textAlign="center" mb="1rem">
            ...
            >
              {t(
                "Deposit and withdraw at any time. The more staking those tokens, the more interesting reward you have!"
              )}
            </Box>
          </Box>
        </>
