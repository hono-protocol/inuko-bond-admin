...
import { INUKO_TAX, ROUTER_ADDRESS } from "../../config/constants";
...
export default function AddLiquidity({
  ...
  const modalHeader = () => {
    const hasInuko =
      currencies[Field.CURRENCY_A]?.symbol === "INUKO" ||
      currencies[Field.CURRENCY_B]?.symbol === "INUKO";
    const lpAmount = hasInuko
      ? new RawBigNumber(liquidityMinted.toSignificant(18)).multipliedBy(
          1 - INUKO_TAX
        )
      : new RawBigNumber(liquidityMinted.toSignificant(18));
      ...
      <AutoColumn>
        <Flex alignItems="center">
          ...
          {!!hasInuko && (
            ...
            >
              {t("This is estimated after %tax%% tax", {
                tax: INUKO_TAX * 100.0,
              })}
            </Text>
          )}
          ...
          <AutoColumn gap="20px">
            ...
            {addIsUnsupported ? (
              ...
              <AutoColumn gap="md">
                ...
                >
                  {error ??
                    (isValidInuko ? t("Supply") : t("Exceed INUKO Max Amount"))}
                </Button>
              </AutoColumn>
            )}
          </AutoColumn>
